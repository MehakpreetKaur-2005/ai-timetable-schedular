...
import {
    mockDepartments, mockSections
} from '../data/mockData';

export default function Dashboard() {
    const navigate = useNavigate();
    const { systemStatus, refreshStatus, schedule, fitnessScore } = useSchedule();
    ...
    const stats = [
        ...
        { label: 'Sections', value: mockSections.length, icon: <HiOutlineRectangleGroup />, tint: 'mint' },
